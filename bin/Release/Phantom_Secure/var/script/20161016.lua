...
mSleep(100);
os.execute("am start com.tencent.mm/.plugin.sns.ui.SnsLongMsgUI") --runApp("com.tencent.mm","com.tencent.mm.plugin.sns.ui.SnsLongMsgUI") --启动微信并打开添加好友
--toast("微信加载中");
mSleep(10 * 1000);
...
mSleep(800);
----------------
	x, y = findColorInRegionFuzzy(0x1aad19, 90, 1, 1, 1080, 1920); --找发送  坐标
	mSleep(500)
	if x ~= -1 and y ~= -1 then
		touchDown(1, x + 50, y+ 50);      --那么单击发送
		mSleep(100);
		touchUp(1, x+50, y+50);
		toast("初始化文字朋友圈");
		mSleep(2000);
...
-------------
	...
	x, y = findColorInRegionFuzzy(0x2c6830, 90, 855, 81, 1062, 185); --找发送  坐标
	if x ~= -1 and y ~= -1 then
		a = y + 100
		touchDown(1, x, a);
		mSleep(100);
...
mSleep(500);                --延迟 0.5 秒
toast(hy2);
os.execute('input text GREETINGS *Phantom* is my name');          --写出字符串
mSleep(1500);

---------------

	x, y = findColorInRegionFuzzy(0x2c6830, 90, 160, 55, 517, 145); --找发送  坐标
	if x ~= -1 and y ~= -1 then
...
::tuwenpengyouquan::
	...
	setScreenScale(true, 720, 1280)  --分辨路设置成720.1280
	mSleep(100);
	r = os.execute("com.tencent.mm/.plugin.sns.ui.SnsTimeLineUI")
	-- runApp("com.tencent.mm","com.tencent.mm.plugin.sns.ui.SnsTimeLineUI") --启动微信并打开添加好友
	toast("微信加载中");
	mSleep(10 * 1000);
	if r == 0 then
		toast("微信启动成功");
...
r = os.execute("com.tencent.mm/.plugin.masssend.ui.MassSendSelectContactUI")
-- runApp("com.tencent.mm","com.tencent.mm.plugin.masssend.ui.MassSendSelectContactUI") --启动微信并打开添加好友
toast("微信加载中");
mSleep(10 * 1000);
...
r = os.execute("com.tencent.mm/.plugin.subapp.ui.pluginapp.AddMoreFriendsByOtherWayUI") -- runApp("com.tencent.mm","com.tencent.mm.plugin.subapp.ui.pluginapp.AddMoreFriendsByOtherWayUI") --启动微信并打开添加好友
toast("微信加载中");
mSleep(10 * 1000);
